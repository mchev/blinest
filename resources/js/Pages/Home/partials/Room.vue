  ...
  <Link :href="`/rooms/${room.id}`" class="relative flex w-full flex-col items-center justify-center rounded-sm bg-gray-100 shadow transition duration-100 ease-in-out hover:z-10 hover:scale-110 dark:bg-gray-500">
    <article>
      <div class="relative overflow-hidden">
        ...
        <div class="absolute bottom-1 left-2 w-auto rounded-sm font-bold">
          <div class="flex items-center">
            <svg xmlns="http://www.w3.org/2000/svg" class="mr-1 h-4 w-4 animate-pulse" viewBox="0 0 20 20" fill="currentColor">
              <path fill-rule="evenodd" d="M9.383 3.076A1 1 0 0110 4v12a1 1 0 01-1.707.707L4.586 13H2a1 1 0 01-1-1V8a1 1 0 011-1h2.586l3.707-3.707a1 1 0 011.09-.217zM14.657 2.929a1 1 0 011.414 0A9.972 9.972 0 0119 10a9.972 9.972 0 01-2.929 7.071 1 1 0 01-1.414-1.414A7.971 7.971 0 0017 10c0-2.21-.894-4.208-2.343-5.657a1 1 0 010-1.414zm-2.829 2.828a1 1 0 011.415 0A5.983 5.983 0 0115 10a5.984 5.984 0 01-1.757 4.243 1 1 0 01-1.415-1.415A3.984 3.984 0 0013 10a3.983 3.983 0 00-1.172-2.828 1 1 0 010-1.415z" clip-rule="evenodd" />
            </svg>
            {{ infos ? infos.current_track_index : room.current_track_index }} / {{ infos ? infos.tracks_count : room.tracks_by_game }}
          </div>
        </div>
      </div>
      <div class="bg-gray-800 uppercase text-gray-100 text-sm p-2 text-center">
        {{ room.name }}
      </div>
    </article>
  </Link>
