...
<template>
  <Link :href="`/rooms/${room.id}`" class="relative flex h-48 w-full flex-col items-center justify-center rounded bg-neutral-800 bg-cover bg-center shadow transition duration-100 ease-in-out hover:z-10 hover:scale-110" :style="`background-image: url(${room.photo});`">
    <article class="relative h-full w-full">
      ...
      <div class="absolute bottom-10 right-2 w-auto">
        <Transition name="slide-fade">
          <svg v-if="playing" xmlns="http://www.w3.org/2000/svg" class="h-4 w-4 animate-pulse" viewBox="0 0 20 20" fill="currentColor">
