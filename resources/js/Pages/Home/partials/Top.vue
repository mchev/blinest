...
<template>
  <Link :href="`/rooms/${room.slug}`" class="relative flex h-48 w-full flex-col items-center justify-center rounded-md bg-neutral-800 transition duration-100 ease-in-out" :title="room.name">
    <article class="relative flex h-full w-full">
