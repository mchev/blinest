...
<template>
    <article ref="cardRef" class="group flex h-full w-full flex-col">
        <div
            class="game-card flex h-full flex-col"
            :class="{ 'game-card--live': isLive }"
        >
            <Link
                :href="roomHref"
            ...
            >
                ...
                >
                    ...
                    <span class="select-none font-black tracking-tighter text-white/[0.07] text-5xl sm:text-6xl">
                        {{ posterInitials }}
                    </span>
                </div>
                ...
                <div class="absolute right-2.5 top-2.5 z-20 flex gap-1">
                    <span
                        ...
                        class="retro-badge flex h-7 w-7 items-center justify-center p-0"
                ...
                <div class="retro-progress absolute bottom-0 left-0 right-0 z-20">
                    <div
                        ...
                        :class="{ 'retro-progress__fill--live': isPlaying }"
            ...
            <div class="game-card__deck flex flex-1 flex-col gap-3">
                ...
                <p
                    ...
                    class="line-clamp-2 text-sm leading-relaxed text-white/70"
                >
                    {{ room.description }}
                </p>
                ...
                <div v-if="isPrivateRoom && room.owner" class="flex items-center gap-2">
                    <img
                        ...
                        :alt="room.owner.name"
                        class="h-5 w-5 rounded-full ring-2 ring-white/20"
                        loading="lazy"
                    />
                ...
                <div
                    v-if="!isCatalog && isPlaying"
                    class="flex h-1 items-center gap-0.5"
                    aria-hidden="true"
                >
                    <span
                        ...
                        :class="[
                            dotActive(index - 1)
                                ? 'bg-white shadow-[0_0_6px_rgb(255_255_255/0.8)]'
                                : dotFilled(index - 1)
                                    ? 'bg-white/50'
                                    : 'bg-white/15',
                        ]"
