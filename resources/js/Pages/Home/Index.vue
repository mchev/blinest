    ...
    <div v-else>
      <div class="flex flex-wrap lg:flex-nowrap">
        ...
        <aside class="order-last w-full lg:order-first lg:w-1/4 lg:pr-12">
          <article class="my-6">
            <div class="mb-6">
              <h3 class="text-xl font-bold">{{ __('Support Blinest') }}</h3>
              <p class="text-sm mb-4">{{ __('Help ensure the longevity and growth of Blinest. Your donation contributes to server costs and ongoing improvements.') }}</p>
              <a href="https://donate.stripe.com/00g2bvf8i08X8De6oo" target="_blank" rel="external nofollow" data-umami-event="Faire un don" class="flex items-center rounded justify-center gap-2 bg-red-500 px-2 py-1 text-center uppercase text-white hover:bg-red-400">
          ...
          <article class="my-6">
            <div class="">
              ...
              <ul class="text-sm list-disc list-inside mb-4">
                <li>Obtenir de l'aide sur l'utilisation du site</li>
                <li>Échanger avec d'autres joueurs</li>
                <li>Suivre les mises à jour d'extraits musicaux</li>
                <li>Participer à l'amélioration du site</li>
              </ul>
              <a href="https://discord.com/invite/uKyVgcxcFa" target="_blank" rel="external nofollow" class="flex items-center rounded justify-center gap-2 bg-shark-500 px-2 py-1 uppercase text-white hover:bg-shark-400" :title="__('Join the Blinest community on Discord')" data-umami-event="Discord button">
