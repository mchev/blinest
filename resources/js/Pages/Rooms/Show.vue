          ...
          <Card class="mt-8">
            <div class="flex flex-col items-center gap-6 text-sm lg:flex-row lg:justify-between">
              ...
              <div class="flex items-center gap-4" v-if="user">
                <button type="button" class="btn-secondary btn-sm flex items-center space-x-2 bg-black/20 hover:bg-black/30">
                  <span>{{ room.tracks_count }}</span>
                  <span>{{ __('Tracks') }}</span>
                </button>
                <button v-if="user.can.sendSuggestion" 
                        class="btn-secondary btn-sm whitespace-nowrap flex items-center space-x-2 bg-black/20 hover:bg-black/30" 
