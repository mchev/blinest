  ...
  <AppLayout>
    <Card class="mx-auto max-w-xl p-12">
      ...
      <form @submit.prevent="submit">
        ...
        <LoadingButton :loading="form.processing" class="btn-primary ml-auto mt-4"
          ><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="mr-2 h-5 w-5">
            <path stroke-linecap="round" stroke-linejoin="round" d="M13.5 10.5V6.75a4.5 4.5 0 119 0v3.75M3.75 21.75h10.5a2.25 2.25 0 002.25-2.25v-6.75a2.25 2.25 0 00-2.25-2.25H3.75a2.25 2.25 0 00-2.25 2.25v6.75a2.25 2.25 0 002.25 2.25z" />
          </svg>
    ...
    <Tip class="mx-auto max-w-xl">
      {{ __('If you are the owner of the room and have forgotten the password, you can change it on') }}&nbsp;<Link :href="route('rooms.index')" class="underline">{{ __("the room's editing page") }}</Link></Tip
    >
  </AppLayout>
</template>
