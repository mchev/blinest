  ...
  <Modal :show="show" @close="close">
    <Card>
      ...
      <form @submit.prevent="submit" id="suggestionForm">
        ...
        <ul v-if="tracks.length" class="mb-4 max-h-60 w-full w-full overflow-y-scroll rounded bg-neutral-700 px-4 py-2 text-sm">
          <li v-for="track in tracks" :key="track.id" class="my-2 border-b border-neutral-600">
            <div class="flex gap-4">
              ...
              <div>
                <ul v-for="answer in track.answers" :key="answer.id" class="flex gap-2">
