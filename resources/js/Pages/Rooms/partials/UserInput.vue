    ...
    <div class="relative flex w-full flex-col">
      <div class="room-input-wrap">
        ...
        <div class="room-input-actions">
                ...
                <div class="px-4 py-2">
                  <div class="flex items-center justify-between mb-3">
                    ...
                    <button
                      ...
                      :class="autoFocus ? 'bg-brand-accent-dark' : 'bg-brand-midnight'"
          ...
          <button
            type="submit"
            class="room-input-submit"
            :disabled="inputDisabled || !text.trim() || isSubmitting"
            :aria-label="__('Send')"
          >
