...
<template>
  <form class="flex w-full items-center justify-center" @submit.prevent="check">
    <div class="relative flex w-full items-center">
      ...
      <input ref="input" v-model="text" type="text" class="h-14 w-full bg-neutral-700 flex-grow rounded-none rounded-bl-md border-none border-none p-2 text-2xl uppercase focus:shadow-none focus:outline-none focus:ring-0" :placeholder="__('Any idea?')" autofocus :readonly="inputDisabled" />
