          ...
          <li v-for="(user, index) in userList" :key="user.id" class="flex items-center rounded border-b border-neutral-600 px-2 py-4 gap-4" :class="{ 'bg-neutral-700': me && me.id === user.id }">
            ...
            <div class="flex flex-grow flex-col">
              ...
              <div class="flex items-center flex-wrap gap-2">
                <span v-for="userAnswer in user.score.answers" v-if="user.score" class="relative flex items-center rounded bg-purple-500 px-1 text-[11px] font-bold uppercase text-white">
