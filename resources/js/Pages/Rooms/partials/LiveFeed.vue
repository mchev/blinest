    ...
    >
      ...
      >
        ...
        <div class="shrink-0 text-right">
          ...
          <p v-else class="text-sm text-brand-accent">✓</p>
          <p v-if="event.speedBonus" class="text-xs text-white/45">⚡</p>
        </div>
      </li>
    </ul>

    <div v-else class="flex flex-1 flex-col items-center justify-center py-8 text-center text-white/45">
