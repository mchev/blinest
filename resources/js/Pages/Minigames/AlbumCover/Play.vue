    ...
    <div v-if="track" class="overflow-hidden rounded-2xl border-2 border-teal-500/20 bg-neutral-900/80 shadow-2xl shadow-teal-500/5 ring-1 ring-white/5">
      <div class="flex flex-col gap-6 p-6">
        ...
        <div class="flex justify-center">
          <div class="relative aspect-square w-full max-w-sm overflow-hidden rounded-xl border-2 border-neutral-600 bg-neutral-800 shadow-xl ring-2 ring-teal-500/20">
            <img
              ...
              "
            />
            <div v-else class="flex h-full w-full items-center justify-center text-4xl font-bold text-neutral-500">?</div>
          </div>
        </div>
