...
const forceClearRounds = () => {
  ...
  resetOutputs()
  router.post(
    route('admin.force-clear-rounds'),
    {},
    {
      only: ['flash'],
      onSuccess: () => {
  ...
  <AdminLayout>
    <section class="space-y-8">
      ...
      <div class="grid grid-cols-3 gap-8 border-b border-gray-200 pb-8">
        <div class="prose col-span-1 dark:prose-invert">
        ...
        <div class="col-span-2">
          <div class="space-y-4 rounded bg-gray-100 p-4 dark:bg-gray-800">
      ...
      <div class="grid grid-cols-3 gap-8 border-b border-gray-200 pb-8">
        ...
        <div class="col-span-2">
          <button class="btn btn-primary" @click="forceClearRounds" :disabled="isLoadingClearRounds">
            {{ isLoadingClearRounds ? 'Chargement...' : 'Forcer la mise à zéro de toutes les rooms' }}
          </button>
          <div v-if="clearRoundsOutput" class="mt-4 rounded bg-gray-100 p-4 dark:bg-gray-800">
      ...
      <div class="grid grid-cols-3 gap-8 border-b border-gray-200 pb-8">
        ...
        <div class="col-span-2">
          <button class="btn btn-primary" @click="clearCache" :disabled="isLoadingCache">
            {{ isLoadingCache ? 'Chargement...' : 'Vider le cache' }}
          </button>
          <div class="mt-4 rounded bg-gray-100 p-4 dark:bg-gray-800">
            <p>Driver: {{ cacheDriver }}</p>
          </div>
          <div v-if="cacheOutput" class="mt-4 rounded bg-gray-100 p-4 dark:bg-gray-800">
      ...
      <div class="grid grid-cols-3 gap-8 border-b border-gray-200 pb-8">
        ...
        <div class="col-span-2">
          <button class="btn btn-primary" @click="regenerateTop10" :disabled="isLoadingTop10">
            {{ isLoadingTop10 ? 'Chargement...' : 'Regénérer le top 10 de la semaine' }}
          </button>
          <div v-if="top10Output" class="mt-4 rounded bg-gray-100 p-4 dark:bg-gray-800">
