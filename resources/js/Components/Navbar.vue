  ...
  <div class="md:flex md:flex-shrink-0">
    <div class="flex w-full items-center justify-between px-4 py-2 md:flex-shrink-0 md:px-12">
      <Link :href="route('home')" title="Blinest">
        <logo class="w-24 fill-inherit lg:w-32" name="xmas" />
      ...
      <div class="flex items-center justify-end gap-4">
        <a href="https://shop.blinest.com" :title="__('Blinest Shop')" class="text-green-500" data-umami-event="Shop button">
        ...
        <a href="https://discord.com/invite/uKyVgcxcFa" target="_blank" rel="external nofollow" :title="__('Join the Blinest community on Discord')" data-umami-event="Discord button">
