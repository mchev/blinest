  ...
  <div class="md:flex md:flex-shrink-0">
    <div class="flex w-full items-center justify-between px-4 py-2 md:flex-shrink-0 md:px-12">
      <Link :href="route('home')" title="Blinest">
        ...
        <p class="text-sm text-neutral-500 mt-1">{{ __('Test your musical knowledge') }}</p>
      </Link>
      ...
      <div class="flex items-center justify-end gap-4">
        <a href="https://shop.blinest.com" :title="__('Blinest Shop')" class="text-green-500 umami--click--shop-button">
