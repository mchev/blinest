...
<template>
  <div :class="$attrs.class">
    ...
    <div class="relative">
      ...
      <input :id="id" ref="input" v-bind="{ ...$attrs, class: null }" class="form-input px-2" :class="{ error: error, 'pl-10': prependIcon, 'pr-10': appendIcon }" :type="type" :value="modelValue" @input="$emit('update:modelValue', $event.target.value)" />
