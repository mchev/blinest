      ...
      <div class="grid grid-cols-1 md:grid-cols-4 gap-8 pb-8">
        <div class="col-span-1">
          ...
          <div class="flex space-x-4">
            <a href="https://discord.gg/blinest" target="_blank" rel="external nofollow" class="text-white/70 transition-colors hover:text-brand-accent">
            ...
            <a href="https://github.com/mchev/blinest" target="_blank" rel="external nofollow" class="text-white/70 transition-colors hover:text-brand-accent">
        ...
        <div class="col-span-1">
          <h3 class="retro-footer-title">{{ __('Legal') }}</h3>
          <ul class="space-y-2">
            <li>
              <Link :href="route('pages.show', 'mentions-legales')" class="text-white/70 transition-colors hover:text-white">
                {{ __('Terms and Conditions') }}
              </Link>
            </li>
            <li>
              <Link :href="route('pages.show', 'politique-de-confidentialite')" class="text-white/70 transition-colors hover:text-white">
                {{ __('Privacy Policy') }}
              </Link>
            </li>
          </ul>
