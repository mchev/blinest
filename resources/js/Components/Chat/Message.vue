...
<template>
  <div ref="messageRef" class="chat-message group">
    ...
    <div class="flex items-start gap-3">
      <div class="relative">
        <img :src="message.user.photo" :alt="message.user.name" class="h-10 w-10 rounded-full border-2 object-cover" :class="isFromModerator ? 'border-brand-accent' : 'border-white/20'" loading="lazy" />
