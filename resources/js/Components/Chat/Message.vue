...
<template>
  <div ref="messageRef" class="chat-message group">
    ...
    <div class="flex items-start gap-3">
      <div class="relative">
        <UserAvatar :user="message.user" :img-class="['h-10 w-10 rounded-full border-2 object-cover', isFromModerator ? 'border-brand-accent' : 'border-white/20'].join(' ')" crown-size="md" />
