...
<template>
  <nav class="fixed bottom-0 left-0 right-0 z-50 md:hidden border-t border-neutral-800/50 bg-gradient-to-t from-neutral-900/95 to-neutral-900/80 backdrop-blur-md safe-area-inset-bottom">
    <div class="flex items-center justify-evenly px-2 py-3">
      ...
      >
        <div class="flex h-10 w-10 items-center justify-center rounded-full bg-neutral-800/50 border border-neutral-700/50">
      ...
      <Link 
        ...
        class="flex items-center justify-center min-w-0 flex-1 px-2 py-2 rounded-lg transition-colors duration-200 hover:bg-neutral-800/30"
      >
        <div class="flex h-10 w-10 items-center justify-center rounded-full bg-neutral-800/50 border border-neutral-700/50 text-yellow-500">
