...
<template>
  <dropdown placement="bottom-end" :autoClose="false">
    ...
    <template #dropdown>
      <div class="p-2">
        <input id="default-range" type="range" min="0" max="1" step="0.1" v-model="volume" class="h-2 w-full cursor-pointer appearance-none rounded-lg bg-gray-200 dark:bg-gray-700" />
      </div>
    </template>
  </dropdown>
</template>
