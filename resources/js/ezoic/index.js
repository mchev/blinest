const excludedPathPatterns = [/^\/login$/, /^\/register$/, /^\/auth\//, /^\/callback\//, /^\/guest\//, /^\/admin(?:\/|$)/, /^\/moderation(?:\/|$)/, /^\/user\/banned$/, /^\/create\/room$/, /^\/playlists\/[^/]+\/edit$/, /^\/rooms\/[^/]+\/edit$/, /^\/minigames\/(quiz|who-sang|anagram|first-letter|album-cover)$/]
