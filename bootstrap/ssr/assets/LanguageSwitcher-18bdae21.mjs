    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(_sfc_main$4, mergeProps({ placement: "bottom-end" }, _attrs), {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="group flex cursor-pointer select-none items-center"${_scopeId}><div class="mr-1 whitespace-nowrap"${_scopeId}><img${ssrRenderAttr("src", unref(user).photo)} class="w-10 h-10 rounded-full"${ssrRenderAttr("alt", unref(user).name)}${_scopeId}></div></div>`);
          } else {
            return [
...
function _sfc_ssrRender(_ctx, _push, _parent, _attrs, $props, $setup, $data, $options) {
  ...
  _push(ssrRenderComponent(_component_dropdown, mergeProps({ placement: "bottom-end" }, _attrs), {
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        _push2(`<div class="group flex cursor-pointer select-none items-center"${_scopeId}><div class="mr-1 whitespace-nowrap"${_scopeId}><span class="uppercase"${_scopeId}>${ssrInterpolate(_ctx.$page.props.locale)}</span></div></div>`);
      } else {
        return [
          createVNode("div", { class: "group flex cursor-pointer select-none items-center" }, [
            createVNode("div", { class: "mr-1 whitespace-nowrap" }, [
