...
import { _ as _sfc_main$1 } from "./Pagination-d517bd16.mjs";
                  ...
                  createVNode("tbody", null, [
                    (openBlock(true), createBlock(Fragment, null, renderList(__props.trashedMessages.data, (message) => {
                      return openBlock(), createBlock("tr", {
                        ...
                        createVNode("td", { class: "border-t px-2 py-4" }, [
                          createVNode("span", { class: "text-sm italic break-all" }, toDisplayString(message.body), 1)
                        ]),
                        createVNode("td", { class: "border-t px-2 py-4" }, [
                          createVNode("div", { class: "flex flex-col" }, [
