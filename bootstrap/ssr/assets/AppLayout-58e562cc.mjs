...
import { _ as _sfc_main$2 } from "./Navbar-4b87aa4b.mjs";
const _sfc_main$1 = {
  __name: "Footer",
  __ssrInlineRender: true,
  setup(__props) {
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "mt-8 border-t border-neutral-500 text-sm text-neutral-500 md:flex md:flex-shrink-0" }, _attrs))}><div class="flex w-full items-center justify-between py-2 md:flex-shrink-0"> Blinest <ul class="flex flex-col gap-4 md:flex-row"><li>`);
