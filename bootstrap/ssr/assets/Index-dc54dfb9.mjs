        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            ssrRenderList(__props.bestUsers, (score, index) => {
              _push2(`<li class="m-4 flex flex-col items-center"${_scopeId}><div class="relative"${_scopeId}><span class="absolute -left-2 -top-2 flex h-8 w-8 items-center justify-center rounded-full bg-neutral-100 p-1 text-neutral-700"${_scopeId}>${ssrInterpolate(index + 1)}</span><img${ssrRenderAttr("src", score.user.photo)} class="mb-2 h-20 w-20 rounded-full"${_scopeId}></div><span class="mb-1 font-bold"${_scopeId}>${ssrInterpolate(score.user.name)}</span><span${_scopeId}>${ssrInterpolate(score.total_score)}<sup${_scopeId}>PTS</sup></span></li>`);
            });
            ...
            ssrRenderList(__props.bestTeams, (score, index) => {
              ...
              _push2(ssrRenderComponent(unref(Link), {
                ...
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<div class="relative"${_scopeId2}><span class="absolute -left-2 -top-2 flex h-8 w-8 items-center justify-center rounded-full bg-neutral-100 p-1 text-neutral-700"${_scopeId2}>${ssrInterpolate(index + 1)}</span><img${ssrRenderAttr("src", score.team.photo)} class="mb-2 h-20 w-20 rounded-full"${_scopeId2}></div><span class="mb-1 font-bold"${_scopeId2}>${ssrInterpolate(score.team.name)}</span><span${_scopeId2}>${ssrInterpolate(score.total_score)}<sup${_scopeId2}>PTS</sup></span>`);
                  } else {
                    return [
                      createVNode("div", { class: "relative" }, [
                        createVNode("span", { class: "absolute -left-2 -top-2 flex h-8 w-8 items-center justify-center rounded-full bg-neutral-100 p-1 text-neutral-700" }, toDisplayString(index + 1), 1),
                        createVNode("img", {
