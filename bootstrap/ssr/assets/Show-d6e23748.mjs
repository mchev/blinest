...
import { _ as _sfc_main$3 } from "./Share-188342a1.mjs";
                  ...
                  if (_push3) {
                    ...
                    return [
                      createVNode("form", {
                        ...
                        unref(user).permissions.canUploadImage ? (openBlock(), createBlock(FileInput, {
                          key: 0,
                          modelValue: unref(form).photo,
                          "onUpdate:modelValue": ($event) => unref(form).photo = $event,
                          label: _ctx.__("Image"),
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  ssrRenderList(Object.values(__props.members).sort((a, b) => b.score - a.score), (member, index) => {
                    ...
                    _push3(` ${ssrInterpolate(member.name)}</div><div class="flex items-center gap-2 mr-4"${_scopeId2}>`);
