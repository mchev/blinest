                    ...
                    _push3(ssrRenderComponent(unref(Link), {
                      ...
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          ...
                          _push4(`<div class="flex flex-col"${_scopeId3}>${ssrInterpolate(room.name)} <small class="text-gray-500 truncate max-w-[18rem]"${_scopeId3}>${ssrInterpolate(room.description)}</small></div>`);
                          if (room.deleted_at) {
                          ...
                          return [
                            ...
                            createVNode("div", { class: "flex flex-col" }, [
                              ...
                              createVNode("small", { class: "text-gray-500 truncate max-w-[18rem]" }, toDisplayString(room.description), 1)
                            ]),
