                    ...
                    _push3(ssrRenderComponent(unref(Link), {
                      ...
                      default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                        if (_push4) {
                          ...
                          _push4(`<div class="flex flex-col"${_scopeId3}>${ssrInterpolate(playlist.name)} <small class="max-w-md truncate text-xs"${_scopeId3}>${ssrInterpolate(playlist.description)}</small></div>`);
                          ...
                          return [
                            ...
                            createVNode("div", { class: "flex flex-col" }, [
                              ...
                              createVNode("small", { class: "max-w-md truncate text-xs" }, toDisplayString(playlist.description), 1)
                            ]),
