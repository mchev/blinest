...
import { _ as _sfc_main$c } from "./Pagination-6aa0e1ca.mjs";
  ...
  setup(__props, { emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (_ctx.$attrs.modelValue && __props.field == _ctx.$attrs.modelValue.field) {
        _push(`<div class="ml-1 inline-block align-middle">`);
              ...
              _push2(ssrRenderComponent(Card, { class: "shadow-none" }, {
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    ...
                    _push3(`<div class="mt-4 flex items-center justify-end gap-2"${_scopeId2}>`);
      ...
      _push(ssrRenderComponent(Card, null, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`<button class="btn-secondary btn-sm"${_scopeId}><svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="mr-2 h-5 w-5"${_scopeId}><path fill-rule="evenodd" d="M12 2.25a.75.75 0 01.75.75v11.69l3.22-3.22a.75.75 0 111.06 1.06l-4.5 4.5a.75.75 0 01-1.06 0l-4.5-4.5a.75.75 0 111.06-1.06l3.22 3.22V3a.75.75 0 01.75-.75zm-9 13.5a.75.75 0 01.75.75v2.25a1.5 1.5 0 001.5 1.5h13.5a1.5 1.5 0 001.5-1.5V16.5a.75.75 0 011.5 0v2.25a3 3 0 01-3 3H5.25a3 3 0 01-3-3V16.5a.75.75 0 01.75-.75z" clip-rule="evenodd"${_scopeId}></path></svg> Importer une playlist </button><div class="flex items-center gap-2"${_scopeId}>`);
            _push2(ssrRenderComponent(_sfc_main$8, {
