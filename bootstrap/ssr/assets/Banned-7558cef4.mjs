          ...
          if (_push2) {
            _push2(ssrRenderComponent(Card, { class: "mx-auto" }, {
              header: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="flex w-full items-center justify-between"${_scopeId2}><h1 class="my-4 text-xl text-red-500"${_scopeId2}>Vous avez été banni de blinest.com !</h1></div>`);
                } else {
                  return [
                    createVNode("div", { class: "flex w-full items-center justify-between" }, [
                      createVNode("h1", { class: "my-4 text-xl text-red-500" }, "Vous avez été banni de blinest.com !")
                    ])
                  ];
                }
              }),
