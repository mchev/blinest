    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(Card, { class: "flex-grow" }, {
        header: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<h3 class="mx-auto text-lg uppercase"${_scopeId}>Utilisateurs</h3>`);
          } else {
            return [
              createVNode("h3", { class: "mx-auto text-lg uppercase" }, "Utilisateurs")
            ];
          }
        }),
      ...
      _push(ssrRenderComponent(Card, { class: "flex-grow" }, {
        header: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<h3 class="mx-auto text-lg uppercase"${_scopeId}>Playlists publiques</h3>`);
          } else {
            return [
              createVNode("h3", { class: "mx-auto text-lg uppercase" }, "Playlists publiques")
            ];
          }
        }),
        default: withCtx((_, _push2, _parent2, _scopeId) => {
      ...
      _push(ssrRenderComponent(Card, { class: "flex-grow" }, {
        header: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<h3 class="mx-auto text-lg uppercase"${_scopeId}>Rooms publiques</h3>`);
          } else {
            return [
              createVNode("h3", { class: "mx-auto text-lg uppercase" }, "Rooms publiques")
            ];
          }
        }),
        default: withCtx((_, _push2, _parent2, _scopeId) => {
      ...
      _push(ssrRenderComponent(Card, { class: "flex-grow" }, {
        header: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<h3 class="mx-auto text-lg uppercase"${_scopeId}>Utilisateurs bannis</h3>`);
          } else {
            return [
              createVNode("h3", { class: "mx-auto text-lg uppercase" }, "Utilisateurs bannis")
            ];
          }
        }),
        default: withCtx((_, _push2, _parent2, _scopeId) => {
