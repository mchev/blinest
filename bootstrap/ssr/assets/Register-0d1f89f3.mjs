...
import _sfc_main$3 from "./Socialite-680e42f3.mjs";
      ...
      _push(ssrRenderComponent(_sfc_main$1, _attrs, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            _push2(`<div class="mx-auto flex flex-wrap gap-4 lg:max-w-3xl justify-center"${_scopeId}>`);
            ...
            return [
              ...
              createVNode("div", { class: "mx-auto flex flex-wrap gap-4 lg:max-w-3xl justify-center" }, [
