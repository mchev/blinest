...
import _sfc_main$2 from "./PodiumModal-951e3b18.mjs";
                  ...
                  default: withCtx(() => [
                    (openBlock(true), createBlock(Fragment, null, renderList(userList.value, (user, index) => {
                      return openBlock(), createBlock("li", {
                        key: user.id,
                        class: ["flex items-center rounded border-b border-neutral-600 px-2 py-4 gap-4", { "bg-neutral-700": unref(me) && unref(me).id === user.id }]
                      }, [
                        ...
                        createVNode("div", { class: "flex flex-grow flex-col" }, [
                          ...
                          createVNode("div", { class: "flex items-center flex-wrap gap-1" }, [
