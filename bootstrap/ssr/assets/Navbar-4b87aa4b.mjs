...
import { _ as _sfc_main$9, L as LanguageSwitcher, a as _sfc_main$b } from "./LanguageSwitcher-e37332a0.mjs";
...
const _sfc_main$6 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<input class="hidden" type="text" name="search_term_string"${ssrRenderAttr("value", unref(form).search)} required></form></div>`);
    };
  }
};
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (popup.value) {
        _push(`<div class="absolute top-0 left-0 right-0 z-30 flex w-full justify-center"><div class="my-2 flex max-w-2xl rounded bg-neutral-700 p-2">`);
      ...
      _push(ssrRenderComponent(_sfc_main$8, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="relative" title="Notifications"${_scopeId}>`);
        ...
        dropdown: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            ...
            if (notifications.value.length) {
              _push2(`<ul class="max-h-96 max-w-xl overflow-y-scroll pr-2"${_scopeId}><!--[-->`);
              ssrRenderList(notifications.value, (notification) => {
                _push2(`<li class="my-2 flex rounded bg-neutral-700 p-2"${_scopeId}>`);
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(unref(Link), {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_sfc_main$9, { class: "w-24 fill-inherit lg:w-32" }, null, _parent2, _scopeId));
          } else {
            return [
      ...
      _push(ssrRenderComponent(_sfc_main$6, { class: "mt-1 hidden md:block" }, null, _parent));
      _push(`<div class="flex items-center justify-end gap-4">`);
      if (unref(user)) {
        _push(ssrRenderComponent(unref(Link), {
      ...
      _push(`<a href="https://discord.com/invite/uKyVgcxcFa" target="_blank"${ssrRenderAttr("title", _ctx.__("Join the Blinest community on Discord"))} class="umami--click--discord-button">`);
      ...
      _push(ssrRenderComponent(unref(Link), {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-5 h-5"${_scopeId}><path fill-rule="evenodd" d="M2.25 12c0-5.385 4.365-9.75 9.75-9.75s9.75 4.365 9.75 9.75-4.365 9.75-9.75 9.75S2.25 17.385 2.25 12zm11.378-3.917c-.89-.777-2.366-.777-3.255 0a.75.75 0 01-.988-1.129c1.454-1.272 3.776-1.272 5.23 0 1.513 1.324 1.513 3.518 0 4.842a3.75 3.75 0 01-.837.552c-.676.328-1.028.774-1.028 1.152v.75a.75.75 0 01-1.5 0v-.75c0-1.279 1.06-2.107 1.875-2.502.182-.088.351-.199.503-.331.83-.727.83-1.857 0-2.584zM12 18a.75.75 0 100-1.5.75.75 0 000 1.5z" clip-rule="evenodd"${_scopeId}></path></svg>`);
          } else {
            return [
              (openBlock(), createBlock("svg", {
                xmlns: "http://www.w3.org/2000/svg",
