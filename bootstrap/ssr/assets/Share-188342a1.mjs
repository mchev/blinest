...
import { _ as _sfc_main$2 } from "./Modal-e38f3366.mjs";
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (message.value.content) {
        _push(`<div class="${ssrRenderClass([message.value.status ? "bg-green-500" : "bg-red-500", "absolute right-0 bottom-full mb-1 shadow text-white rounded-lg p-1 text-xs"])}">${ssrInterpolate(message.value.content)}</div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<div class="flex"><div type="text" id="website-admin" class="font-mono rounded-none rounded-l-lg bg-gray-50 border border-gray-300 text-gray-900 focus:ring-blue-500 focus:border-blue-500 min-w-0 text-xs border-gray-300 px-1.5 py-1 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">${ssrInterpolate(__props.text)}</div><span class="inline-flex cursor-pointer items-center px-2 text-sm text-gray-900 bg-gray-200 border border-l-0 border-gray-300 rounded-r-md opacity-80 hover:opacity-100 dark:bg-gray-600 dark:text-gray-400 dark:border-gray-600"><svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" viewBox="0 0 20 20" fill="currentColor"><path d="M8 3a1 1 0 011-1h2a1 1 0 110 2H9a1 1 0 01-1-1z"></path><path d="M6 3a2 2 0 00-2 2v11a2 2 0 002 2h8a2 2 0 002-2V5a2 2 0 00-2-2 3 3 0 01-3 3H9a3 3 0 01-3-3z"></path></svg></span></div></span>`);
    };
  }
};
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_sfc_main$2, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="p-6"${_scopeId}><h2 class="my-4 text-xl"${_scopeId}>${ssrInterpolate(_ctx.__("Share this page"))}</h2><p class="text-sm mb-1"${_scopeId}>Copier le lien :</p>`);
            ...
            return [
              createVNode("div", { class: "p-6" }, [
                ...
                createVNode("p", { class: "text-sm mb-1" }, "Copier le lien :"),
