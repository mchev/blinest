...
import { _ as _sfc_main$6, a as _sfc_main$8 } from "./PlaylistsManager-f0ca0bd6.mjs";
import { C as Card } from "./Card-eda4b3e2.mjs";
import { T as Tip } from "./Tip-9a139e5c.mjs";
import { _ as _sfc_main$2 } from "./Share-188342a1.mjs";
import "lodash/pickBy.js";
import "lodash/throttle.js";
import "lodash/mapValues.js";
import _sfc_main$7 from "./EditOptionsForm-88410024.mjs";
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_sfc_main$1, null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<h1 class="mb-8 text-3xl font-bold flex items-center gap-2"${_scopeId}>`);
                    ...
                    createVNode("form", {
                      ...
                      createVNode("div", { class: "flex" }, [
                        createVNode("div", { class: "flex flex-wrap" }, [
                          ...
                          __props.room.is_pro || __props.room.is_public || unref(user).permissions.canUploadImage ? (openBlock(), createBlock(FileInput, {
                            key: 0,
                            modelValue: unref(form).photo,
                            "onUpdate:modelValue": ($event) => unref(form).photo = $event,
                            error: unref(form).errors.photo,
            ...
            _push2(ssrRenderComponent(_sfc_main$6, { room: __props.room }, null, _parent2, _scopeId));
            ...
            _push2(ssrRenderComponent(Card, { class: "mb-4" }, {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(ssrRenderComponent(_sfc_main$7, { room: __props.room }, null, _parent3, _scopeId2));
                } else {
                  return [
            ...
            return [
              createVNode("h1", { class: "mb-8 text-3xl font-bold flex items-center gap-2" }, [
