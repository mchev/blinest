...
import _sfc_main$3 from "./Rooms-fc1ffe1e.mjs";
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(unref(Head), null, {
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<title${_scopeId}>${ssrInterpolate(_ctx.__("Free multiplayer music quizzes"))}</title><meta name="description" content="Simple et efficace! Blind-tests multijoueurs, Années 2000, Disney, Chanson française, Années 80, etc."${_scopeId}>`);
          } else {
            return [
              createVNode("title", null, toDisplayString(_ctx.__("Free multiplayer music quizzes")), 1),
              createVNode("meta", {
                name: "description",
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            if (__props.search_result) {
              _push2(`<section${_scopeId}><div class="grid grid-cols-1 gap-4 md:grid-cols-4 lg:grid-cols-6"${_scopeId}><!--[-->`);
              ...
              if (!__props.filters.search) {
                ...
                if (__props.top_rooms) {
                  _push2(`<div class="relative mb-4 flex-grow"${_scopeId}><h2 class="mb-1 text-xl text-neutral-400 lg:text-2xl"${_scopeId}>TOP 5</h2>`);
              ...
              if (__props.categories.length) {
                ...
                ssrRenderList(__props.categories, (category) => {
                  ...
                  if (category.rooms.length) {
                    _push2(`<div class="relative mb-4"${_scopeId}><h2 class="mb-1 text-xl text-neutral-400 lg:text-2xl"${_scopeId}>${ssrInterpolate(category.name)}</h2>`);
                    _push2(ssrRenderComponent(_sfc_main$3, {
              ...
              if (__props.private_rooms && __props.private_rooms.length) {
                _push2(`<section${_scopeId}><div class="relative"${_scopeId}><h2 class="mb-1 text-xl text-neutral-400 lg:text-2xl"${_scopeId}>${ssrInterpolate(_ctx.__("Private rooms"))}</h2>`);
                _push2(ssrRenderComponent(_sfc_main$3, {
              ...
              if (__props.user_rooms && __props.user_rooms.length) {
                _push2(`<section${_scopeId}><div class="relative"${_scopeId}><h2 class="mb-1 text-xl text-neutral-400 lg:text-2xl"${_scopeId}>${ssrInterpolate(_ctx.__("My rooms"))}</h2>`);
                _push2(ssrRenderComponent(_sfc_main$3, {
            ...
            return [
              __props.search_result ? (openBlock(), createBlock("section", { key: 0 }, [
                createVNode("div", { class: "grid grid-cols-1 gap-4 md:grid-cols-4 lg:grid-cols-6" }, [
                ...
                !__props.filters.search ? (openBlock(), createBlock("section", { key: 0 }, [
                  createVNode("div", { class: "flex flex-wrap items-center" }, [
                    __props.top_rooms ? (openBlock(), createBlock("div", {
                      ...
                      createVNode("h2", { class: "mb-1 text-xl text-neutral-400 lg:text-2xl" }, "TOP 5"),
                ...
                __props.categories.length ? (openBlock(true), createBlock(Fragment, { key: 1 }, renderList(__props.categories, (category) => {
                  return openBlock(), createBlock("section", {
                    ...
                    category.rooms.length ? (openBlock(), createBlock("div", {
                      ...
                      createVNode("h2", { class: "mb-1 text-xl text-neutral-400 lg:text-2xl" }, toDisplayString(category.name), 1),
                      createVNode(_sfc_main$3, {
                        rooms: category.rooms,
                        id: category.id
                      }, null, 8, ["rooms", "id"])
                ...
                __props.private_rooms && __props.private_rooms.length ? (openBlock(), createBlock("section", { key: 2 }, [
                  createVNode("div", { class: "relative" }, [
                    createVNode("h2", { class: "mb-1 text-xl text-neutral-400 lg:text-2xl" }, toDisplayString(_ctx.__("Private rooms")), 1),
                    createVNode(_sfc_main$3, {
                      rooms: __props.private_rooms,
                      id: "private"
                    }, null, 8, ["rooms"])
                ...
                __props.user_rooms && __props.user_rooms.length ? (openBlock(), createBlock("section", { key: 3 }, [
                  createVNode("div", { class: "relative" }, [
                    createVNode("h2", { class: "mb-1 text-xl text-neutral-400 lg:text-2xl" }, toDisplayString(_ctx.__("My rooms")), 1),
                    createVNode(_sfc_main$3, {
                      rooms: __props.user_rooms,
                      id: "private"
                    }, null, 8, ["rooms"])
