          ...
          if (_push2) {
            _push2(ssrRenderComponent(Card, { class: "mx-auto" }, {
              header: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="flex w-full items-center justify-between"${_scopeId2}><h1 class="text-xl my-4"${_scopeId2}>${ssrInterpolate(__props.page.title)}</h1><small class="text-xs text-neutral-500"${_scopeId2}>${ssrInterpolate(_ctx.__("Last revision"))} : ${ssrInterpolate(__props.page.date)}</small></div>`);
                } else {
                  return [
                    createVNode("div", { class: "flex w-full items-center justify-between" }, [
                      createVNode("h1", { class: "text-xl my-4" }, toDisplayString(__props.page.title), 1),
