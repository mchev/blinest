...
import { F as FlashMessages } from "./LanguageSwitcher-e37332a0.mjs";
import "./Dropdown-6785e0d2.mjs";
import "./Icon-4a47e6e0.mjs";
import { _ as _sfc_main$6 } from "./Navbar-4b87aa4b.mjs";
import { C as Card } from "./Card-ee13c838.mjs";
import { S as Spinner } from "./Spinner-ec1c59c5.mjs";
import { _ as _sfc_main$7 } from "./Modal-61e7836d.mjs";
...
import { _ as _sfc_main$a } from "./Share-6d7e5e1b.mjs";
import _sfc_main$c from "./LoginForm-c82d4b06.mjs";
import _sfc_main$h from "./Controls-9cabd08f.mjs";
import _sfc_main$d from "./Player-5888c20d.mjs";
import _sfc_main$e from "./UserInput-689bd74e.mjs";
import _sfc_main$f from "./Answers-04b9936e.mjs";
import _sfc_main$g from "./Ranking-5d847510.mjs";
import _sfc_main$i from "./FinishedRoundModal-636596b5.mjs";
import _sfc_main$j from "./SendSuggestionModal-2334b473.mjs";
...
import "./EditOptionsForm-78776de2.mjs";
import "./CheckboxInput-934baa4b.mjs";
import "./PodiumModal-6b4b587a.mjs";
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<!--[--><div class="flex h-full flex-col"><div class="flex items-center justify-center gap-2 px-2 py-4">`);
      if (!reported.value) {
          ...
          if (_push2) {
            ...
            if (joined.value || !unref(user)) {
              ...
              _push2(ssrRenderComponent(Card, null, {
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<div class="flex flex-col items-center gap-4 text-sm lg:flex-row lg:justify-between"${_scopeId2}><div${_scopeId2}><div class="mx-auto flex flex-wrap items-center gap-4"${_scopeId2}><span class="uppercase text-neutral-500"${_scopeId2}>Modos</span><!--[-->`);
