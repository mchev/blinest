    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(_sfc_main$1, mergeProps({
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="text-sm bg-neutral-800"${_scopeId}><div class="px-4 pt-2 flex items-center justify-between"${_scopeId}><h2 class="font-bold uppercase text-teal-500"${_scopeId}>${ssrInterpolate(__props.room.name)}</h2><button${ssrRenderAttr("title", _ctx.__("Close"))} class="hover:text-white hover:animate-[spin_.5s_ease-in-out]"${_scopeId}><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6"${_scopeId}><path stroke-linecap="round" stroke-linejoin="round" d="M6 18L18 6M6 6l12 12"${_scopeId}></path></svg></button></div>`);
            if (loading.value) {
              _push2(`<div class="flex w-full p-12 items-center justify-center"${_scopeId}>`);
            ...
            return [
              createVNode("div", { class: "text-sm bg-neutral-800" }, [
                createVNode("div", { class: "px-4 pt-2 flex items-center justify-between" }, [
                  createVNode("h2", { class: "font-bold uppercase text-teal-500" }, toDisplayString(__props.room.name), 1),
                  createVNode("button", {
                    onClick: ($event) => _ctx.$emit("close"),
                    title: _ctx.__("Close"),
                    class: "hover:text-white hover:animate-[spin_.5s_ease-in-out]"
                  }, [
                ...
                loading.value ? (openBlock(), createBlock("div", {
                  key: 0,
                  class: "flex w-full p-12 items-center justify-center"
                }, [
                  createVNode(Spinner)
