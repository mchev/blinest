...
const _sfc_main$3 = {
  ...
  setup(__props) {
    return (_ctx, _cache) => {
      return __props.name === "xmas" ? (openBlock(), createElementBlock("svg", _hoisted_1$3, _hoisted_12$1)) : (openBlock(), createElementBlock("svg", _hoisted_13$1, _hoisted_21));
    };
  }
};
const _sfc_main$2 = {
...
const _hoisted_4$1 = /* @__PURE__ */ createBaseVNode("svg", {
  ...
  /* @__PURE__ */ createBaseVNode("polygon", { points: "0 11 2 9 7 14 18 3 20 5 7 18" })
], -1);
const _hoisted_5$1 = { class: "py-4 text-sm font-medium text-white" };
...
const _hoisted_10 = /* @__PURE__ */ createBaseVNode("svg", {
  ...
  /* @__PURE__ */ createBaseVNode("path", { d: "M2.93 17.07A10 10 0 1 1 17.07 2.93 10 10 0 0 1 2.93 17.07zm1.41-1.41A8 8 0 1 0 15.66 4.34 8 8 0 0 0 4.34 15.66zm9.9-8.49L11.41 10l2.83 2.83-1.41 1.41L10 11.41l-2.83 2.83-1.41-1.41L8.59 10 5.76 7.17l1.41-1.41L10 8.59l2.83-2.83 1.41 1.41z" })
], -1);
const _hoisted_11 = {
  key: 0,
...
function _sfc_render$1(_ctx, _cache, $props, $setup, $data, $options) {
  return openBlock(), createElementBlock("div", _hoisted_1$2, [
    _ctx.$page.props.flash.success && $data.show ? (openBlock(), createElementBlock("div", _hoisted_2$2, [
      createBaseVNode("div", _hoisted_3$2, [
        _hoisted_4$1,
        createBaseVNode("div", _hoisted_5$1, toDisplayString(_ctx.$page.props.flash.success), 1)
      ]),
    ...
    (_ctx.$page.props.flash.error || Object.keys(_ctx.$page.props.errors).length > 0) && $data.show ? (openBlock(), createElementBlock("div", _hoisted_8, [
      createBaseVNode("div", _hoisted_9, [
        _hoisted_10,
        _ctx.$page.props.flash.error ? (openBlock(), createElementBlock("div", _hoisted_11, toDisplayString(_ctx.$page.props.flash.error), 1)) : (openBlock(), createElementBlock("div", _hoisted_12, [
          _ctx.$page.props.errors.login ? (openBlock(), createElementBlock("span", _hoisted_13, toDisplayString(_ctx.__(_ctx.$page.props.errors.login)), 1)) : Object.keys(_ctx.$page.props.errors).length === 1 ? (openBlock(), createElementBlock("span", _hoisted_14, toDisplayString(_ctx.__("There is one form error.")), 1)) : (openBlock(), createElementBlock("span", _hoisted_15, toDisplayString(_ctx.__("There are")) + " " + toDisplayString(Object.keys(_ctx.$page.props.errors).length) + " " + toDisplayString(_ctx.__("form errors")) + ".", 1))
        ]))
      ]),
      createBaseVNode("button", {
        type: "button",
...
const FlashMessages = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["render", _sfc_render$1]]);
const _hoisted_1$1 = { class: "group flex cursor-pointer select-none items-center" };
const _hoisted_2$1 = { class: "mr-1 whitespace-nowrap" };
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(_sfc_main$4, { placement: "bottom-end" }, {
        default: withCtx(() => [
          ...
          createBaseVNode("ul", null, [
            createBaseVNode("li", null, [
              createVNode(unref(ne), {
                href: _ctx.route("me"),
                class: normalizeClass(["m-4 flex pl-2", isUrl("me") ? "font-bold" : "font-normal"])
              }, {
                default: withCtx(() => [
            ...
            createBaseVNode("li", null, [
              createVNode(unref(ne), {
                ...
                class: normalizeClass(["m-4 flex pl-2", isUrl("teams") ? "font-bold" : "font-normal"])
              }, {
                default: withCtx(() => [
            ...
            createBaseVNode("li", null, [
              createVNode(unref(ne), {
                ...
                class: normalizeClass(["m-4 flex pl-2", isUrl("rooms") ? "font-bold" : "font-normal"])
              }, {
                default: withCtx(() => [
            ...
            createBaseVNode("li", null, [
              createVNode(unref(ne), {
                ...
                class: normalizeClass(["m-4 flex pl-2", isUrl("playlists") ? "font-bold" : "font-normal"])
              }, {
                default: withCtx(() => [
            ...
            unref(user).admin ? (openBlock(), createElementBlock("li", _hoisted_4, [
              createVNode(unref(ne), {
                href: _ctx.route("admin.dashboard"),
                class: normalizeClass(["m-4 flex pl-2", isUrl("admin") ? "font-bold" : "font-normal"])
              }, {
                default: withCtx(() => [
            ...
            unref(user).is_public_moderator ? (openBlock(), createElementBlock("li", _hoisted_5, [
              createVNode(unref(ne), {
                href: _ctx.route("moderation.index"),
                class: normalizeClass(["m-4 flex pl-2", isUrl("moderation") ? "font-bold" : "font-normal"])
              }, {
                default: withCtx(() => [
...
const _hoisted_1 = { class: "group flex cursor-pointer select-none items-center" };
const _hoisted_2 = {
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  return openBlock(), createBlock(_component_dropdown, { placement: "bottom-end" }, {
    default: withCtx(() => [
      createBaseVNode("div", _hoisted_1, [
        createBaseVNode("div", _hoisted_2, [
          createBaseVNode("span", _hoisted_3, toDisplayString(_ctx.$page.props.locale), 1)
        ])
      ])
    ]),
    dropdown: withCtx(() => [
...
const LanguageSwitcher = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render]]);
export {
  FlashMessages as F,
