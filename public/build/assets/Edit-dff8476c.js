import { P, J, c as createElementBlock, a as createVNode, u as unref, w as withCtx, F as Fragment, o as openBlock, X, b as createBaseVNode, n as ne, d as createTextVNode, t as toDisplayString, g as createCommentVNode, e as withModifiers, v as renderList, h as createBlock, s as Je } from "./app-910e457d.js";
...
const _hoisted_1 = { class: "mb-4 text-3xl font-bold" };
  ...
  setup(__props) {
    ...
    const destroy = () => {
      if (confirm("Are you sure you want to delete this playlist?")) {
        Je.delete(`/playlists/${props.playlist.id}`);
      }
    };
    const restore = () => {
      if (confirm("Are you sure you want to restore this playlist?")) {
        Je.put(`/playlists/${props.playlist.id}/restore`);
      }
    };
    return (_ctx, _cache) => {
        ...
        createVNode(_sfc_main$1, null, {
          default: withCtx(() => [
            ...
            createBaseVNode("div", _hoisted_3, [
              unref(user).id === __props.playlist.user_id ? (openBlock(), createElementBlock("div", _hoisted_4, [
                  ...
                  default: withCtx(() => [
                    createBaseVNode("form", {
                      ...
                      createVNode(_sfc_main$4, {
                        ...
                        "onUpdate:modelValue": _cache[2] || (_cache[2] = ($event) => unref(form).user_id = $event),
                        ...
                        default: withCtx(() => [
                          (openBlock(true), createElementBlock(Fragment, null, renderList(__props.playlist.moderators, (moderator) => {
                            return openBlock(), createElementBlock("option", {
                              value: moderator.id
                            }, toDisplayString(moderator.name), 9, _hoisted_7);
                          }), 256))
                        ]),
                        _: 1
                      }, 8, ["modelValue", "error", "label"]),
                      createBaseVNode("small", null, toDisplayString(_ctx.__("Transfer the playlist management to a moderator.")), 1)
                    ], 40, _hoisted_6)
                  ]),
                  _: 1
                }),
