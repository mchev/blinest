import { k as ref, q as onMounted, L as onUnmounted, h as createBlock, w as withCtx, u as unref, o as openBlock, b as createBaseVNode, x as normalizeStyle, c as createElementBlock, t as toDisplayString, g as createCommentVNode, a as createVNode, R as Transition, n as ne } from "./app-910e457d.js";
const _hoisted_1 = { class: "relative flex h-full w-full transition duration-100 ease-in-out hover:z-10 hover:scale-110" };
const _hoisted_2 = ["innerHTML"];
const _hoisted_3 = { class: "h-full w-2/3" };
const _hoisted_4 = {
  key: 0,
...
const _hoisted_14 = { class: "absolute bottom-0 flex w-full items-center justify-between gap-2 bg-neutral-900 p-2 text-sm uppercase text-gray-100" };
const _hoisted_15 = { class: "truncate font-semibold" };
          ...
          createBaseVNode("article", _hoisted_1, [
            ...
            createBaseVNode("div", _hoisted_3, [
              createBaseVNode("div", {
                ...
                style: normalizeStyle(`background-image: url(${__props.room.photo_src || __props.room.mosaic});`)
              }, [
                !__props.room.is_public ? (openBlock(), createElementBlock("div", _hoisted_4, "@" + toDisplayString(__props.room.owner.name), 1)) : createCommentVNode("", true),
                createBaseVNode("div", {
                  ...
                  createBaseVNode("div", _hoisted_6, [
                    __props.room.password ? (openBlock(), createElementBlock("span", _hoisted_7, [
                    ...
                    createVNode(Transition, { name: "slide-fade" }, {
                      default: withCtx(() => [
                        playing.value ? (openBlock(), createElementBlock("svg", _hoisted_10, _hoisted_12)) : createCommentVNode("", true)
                      ]),
                      _: 1
                    }),
                    createBaseVNode("span", _hoisted_13, toDisplayString(userCounter.value), 1)
                  ])
                ], 8, _hoisted_5)
              ], 4)
            ]),
            createBaseVNode("div", _hoisted_14, [
              createBaseVNode("span", _hoisted_15, toDisplayString(__props.room.name), 1),
              createBaseVNode("div", _hoisted_16, toDisplayString(round.value ? round.value.current : __props.room.current_track_index) + " / " + toDisplayString(__props.room.tracks_by_round), 1)
            ])
          ])
        ]),
        _: 1
