import { a as applyStyles, c as createPopper } from "./Dropdown-f0e2d937.js";
import { B as defineComponent, k as ref, q as onMounted, C as onBeforeUnmount, D as h, E as reactive, G as markRaw, H as watchEffect, T as Teleport, I as customRef, p as nextTick, u as unref, K as getCurrentInstance, l as watch, o as openBlock, c as createElementBlock, t as toDisplayString, g as createCommentVNode, b as createBaseVNode, f as normalizeClass, a as createVNode } from "./app-910e457d.js";
      ...
      (_b = this.tippy) === null || _b === void 0 ? void 0 : _b.setProps({
        getReferenceClientRect: ((_c = this.tippyOptions) === null || _c === void 0 ? void 0 : _c.getReferenceClientRect) || (() => {
          if (isNodeSelection(state.selection)) {
            const node = view2.nodeDOM(from2);
            if (node) {
...
const _hoisted_1 = { class: "$attrs.class" };
  ...
  setup(__props, { emit }) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", _hoisted_1, [
        ...
        editor.value ? (openBlock(), createElementBlock("div", _hoisted_3, [
          createBaseVNode("button", {
            class: normalizeClass(["mr-1 rounded border p-1", { "bg-neutral-600": editor.value.isActive("bold") }]),
            type: "button",
            onClick: _cache[0] || (_cache[0] = ($event) => editor.value.chain().focus().toggleBold().run()),
            disabled: !editor.value.can().chain().focus().toggleBold().run()
          }, "bold", 10, _hoisted_4),
          createBaseVNode("button", {
            class: normalizeClass(["mr-1 rounded border p-1", { "bg-neutral-600": editor.value.isActive("italic") }]),
            type: "button",
            onClick: _cache[1] || (_cache[1] = ($event) => editor.value.chain().focus().toggleItalic().run()),
            disabled: !editor.value.can().chain().focus().toggleItalic().run()
          }, "italic", 10, _hoisted_5),
          createBaseVNode("button", {
            class: normalizeClass(["mr-1 rounded border p-1", { "bg-neutral-600": editor.value.isActive("strike") }]),
            type: "button",
            onClick: _cache[2] || (_cache[2] = ($event) => editor.value.chain().focus().toggleStrike().run()),
            disabled: !editor.value.can().chain().focus().toggleStrike().run()
          }, "strike", 10, _hoisted_6),
          createBaseVNode("button", {
            class: normalizeClass(["mr-1 rounded border p-1", { "bg-neutral-600": editor.value.isActive("code") }]),
            type: "button",
            onClick: _cache[3] || (_cache[3] = ($event) => editor.value.chain().focus().toggleCode().run()),
            disabled: !editor.value.can().chain().focus().toggleCode().run()
          }, "code", 10, _hoisted_7),
          createBaseVNode("button", {
            class: "mr-1 rounded border p-1",
            type: "button",
            onClick: _cache[4] || (_cache[4] = ($event) => editor.value.chain().focus().unsetAllMarks().run())
          }, "clear marks"),
          createBaseVNode("button", {
            class: "mr-1 rounded border p-1",
            type: "button",
            onClick: _cache[5] || (_cache[5] = ($event) => editor.value.chain().focus().clearNodes().run())
          }, "clear nodes"),
          createBaseVNode("button", {
            class: normalizeClass(["mr-1 rounded border p-1", { "bg-neutral-600": editor.value.isActive("paragraph") }]),
            type: "button",
            onClick: _cache[6] || (_cache[6] = ($event) => editor.value.chain().focus().setParagraph().run())
          }, "paragraph", 2),
          createBaseVNode("button", {
            class: normalizeClass(["mr-1 rounded border p-1", { "bg-neutral-600": editor.value.isActive("heading", { level: 1 }) }]),
            type: "button",
            onClick: _cache[7] || (_cache[7] = ($event) => editor.value.chain().focus().toggleHeading({ level: 1 }).run())
          }, "h1", 2),
          createBaseVNode("button", {
            class: normalizeClass(["mr-1 rounded border p-1", { "bg-neutral-600": editor.value.isActive("heading", { level: 2 }) }]),
            type: "button",
            onClick: _cache[8] || (_cache[8] = ($event) => editor.value.chain().focus().toggleHeading({ level: 2 }).run())
          }, "h2", 2),
          createBaseVNode("button", {
            class: normalizeClass(["mr-1 rounded border p-1", { "bg-neutral-600": editor.value.isActive("heading", { level: 3 }) }]),
            type: "button",
            onClick: _cache[9] || (_cache[9] = ($event) => editor.value.chain().focus().toggleHeading({ level: 3 }).run())
          }, "h3", 2),
          createBaseVNode("button", {
            class: normalizeClass(["mr-1 rounded border p-1", { "bg-neutral-600": editor.value.isActive("heading", { level: 4 }) }]),
            type: "button",
            onClick: _cache[10] || (_cache[10] = ($event) => editor.value.chain().focus().toggleHeading({ level: 4 }).run())
          }, "h4", 2),
          createBaseVNode("button", {
            class: normalizeClass(["mr-1 rounded border p-1", { "bg-neutral-600": editor.value.isActive("heading", { level: 5 }) }]),
            type: "button",
            onClick: _cache[11] || (_cache[11] = ($event) => editor.value.chain().focus().toggleHeading({ level: 5 }).run())
          }, "h5", 2),
          createBaseVNode("button", {
            class: normalizeClass(["mr-1 rounded border p-1", { "bg-neutral-600": editor.value.isActive("heading", { level: 6 }) }]),
            type: "button",
            onClick: _cache[12] || (_cache[12] = ($event) => editor.value.chain().focus().toggleHeading({ level: 6 }).run())
          }, "h6", 2),
          createBaseVNode("button", {
            class: normalizeClass(["mr-1 rounded border p-1", { "bg-neutral-600": editor.value.isActive("bulletList") }]),
            type: "button",
            onClick: _cache[13] || (_cache[13] = ($event) => editor.value.chain().focus().toggleBulletList().run())
          }, "bullet list", 2),
          createBaseVNode("button", {
            class: normalizeClass(["mr-1 rounded border p-1", { "bg-neutral-600": editor.value.isActive("orderedList") }]),
            type: "button",
            onClick: _cache[14] || (_cache[14] = ($event) => editor.value.chain().focus().toggleOrderedList().run())
          }, "ordered list", 2),
          createBaseVNode("button", {
            class: normalizeClass(["mr-1 rounded border p-1", { "bg-neutral-600": editor.value.isActive("codeBlock") }]),
            type: "button",
            onClick: _cache[15] || (_cache[15] = ($event) => editor.value.chain().focus().toggleCodeBlock().run())
          }, "code block", 2),
          createBaseVNode("button", {
            class: normalizeClass(["mr-1 rounded border p-1", { "bg-neutral-600": editor.value.isActive("blockquote") }]),
            type: "button",
            onClick: _cache[16] || (_cache[16] = ($event) => editor.value.chain().focus().toggleBlockquote().run())
          }, "blockquote", 2),
          createBaseVNode("button", {
            class: "mr-1 rounded border p-1",
            type: "button",
            onClick: _cache[17] || (_cache[17] = ($event) => editor.value.chain().focus().setHorizontalRule().run())
          }, "horizontal rule"),
          createBaseVNode("button", {
            class: "mr-1 rounded border p-1",
            type: "button",
            onClick: _cache[18] || (_cache[18] = ($event) => editor.value.chain().focus().setHardBreak().run())
          }, "hard break"),
          createBaseVNode("button", {
            class: "mr-1 rounded border p-1",
            type: "button",
            onClick: _cache[19] || (_cache[19] = ($event) => editor.value.chain().focus().undo().run()),
            disabled: !editor.value.can().chain().focus().undo().run()
          }, "undo", 8, _hoisted_8),
          createBaseVNode("button", {
            class: "mr-1 rounded border p-1",
            type: "button",
            onClick: _cache[20] || (_cache[20] = ($event) => editor.value.chain().focus().redo().run()),
            disabled: !editor.value.can().chain().focus().redo().run()
          }, "redo", 8, _hoisted_9)
        ])) : createCommentVNode("", true),
        createVNode(unref(EditorContent), {
          editor: editor.value,
          onUpdate: _cache[21] || (_cache[21] = ($event) => _ctx.$emit("update:modelValue", $event.target.value)),
          class: normalizeClass(["prose prose-invert w-full rounded border border-neutral-500 p-1 text-inherit", { error: __props.error }])
        }, null, 8, ["editor", "class"]),
        __props.error ? (openBlock(), createElementBlock("div", _hoisted_10, toDisplayString(__props.error), 1)) : createCommentVNode("", true)
      ]);
    };
  }
};
