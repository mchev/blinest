import { D as h, k as ref, Z as onUpdated, l as watch, p as nextTick$1, q as onMounted, C as onBeforeUnmount, _ as provide, $ as onBeforeUpdate, Q as computed, c as createElementBlock, a as createVNode, w as withCtx, u as unref, F as Fragment, v as renderList, o as openBlock, h as createBlock } from "./app-910e457d.js";
import _sfc_main$1 from "./Room-507fdf3a.js";
import _sfc_main$2 from "./Top-c52c3cf6.js";
...
const _hoisted_2 = {
  key: 1,
  class: "relative grid grid-cols-1 gap-8 md:grid-cols-5"
};
const _sfc_main = {
  __name: "Rooms",
  props: {
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return __props.rooms && !__props.is_top_5 ? (openBlock(), createElementBlock("div", _hoisted_1, [
        createVNode(unref(Swiper2), {
          ...
          default: withCtx(() => [
            (openBlock(true), createElementBlock(Fragment, null, renderList(__props.rooms, (room) => {
        ...
        (openBlock(true), createElementBlock(Fragment, null, renderList(__props.rooms, (room, index2) => {
